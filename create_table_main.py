...
class CreateTableMain(CreateResultTable):
    def __init__(self, results_manager: ResultsManager | None, fonts_dir: str, template_dir: str, output_path: str, instruction_dir: str,
                 table_settings: dict):
...
# # results_manager.add_result_to_lane(0, b"w", 1, 3, 3, 3, 0, 0, 11.5, 222, 0)
#
# file = open("table_for_results/main_league_6_light.json", encoding='utf8')
# b = json.load(file)
